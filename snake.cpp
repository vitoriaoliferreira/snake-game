    ...
    while(!sair){
        ...
        if (!intro) {
            ...
            if(redraw && al_is_event_queue_empty(event_queue))
            {
                ...
                for(int i=0;i<26;i++)
                    for(int j=0;j<26;j++)
                        if(andou[i][j]>0 && andou[i][j]>=passo-corpo-1){
                            ...
                            i=vet[cont*2+1];//acrescenta 1 para que o vetor se inicie em 0
                            j=vet[cont*2+1];
                ...
                if (contabelha==99){//quando o contador atinge o valor de 99 que ocorre quando o jogo da 99 "voltas" 
                    ...
                    while (teste){  
                        ...
                        for (int k=cont*2+1;k>=1;k-=2)  //mesmo caso da cereja
                            if((iabelha==vet[k]&&jabelha==vet[k-1])||(iabelha==ifruta && jabelha==jfruta)) 
                ...
                if(compara>cont){ //a cobrinha encostou no seu proprio corpo, se a 
